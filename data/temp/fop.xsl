      	...
      	<fo:page-sequence master-reference="A4-portrait">
    		...
    		<fo:static-content flow-name="xsl-region-before">
              <fo:block-container width="4cm" top="0cm" left="13cm" position="absolute">
                <fo:block>
                  <fo:external-graphic content-width="scale-to-fit" width="4cm" height="4cm" src="logo-afpa.jpg"/>
                </fo:block>
              </fo:block-container>
              <fo:block-container font-size="10pt" width="10cm" top="0cm" left="0cm" position="absolute">
              	<fo:block>
					<fo:external-graphic content-width="scale-to-fit" width="0.4cm" height="0.19cm" src="section.png"/>
               	</fo:block>
             ...
             <xsl:for-each select="document/personne">
              ...
              <fo:block-container width="5cm" top="22cm" left="10cm" position="absolute" font-size="10pt">
               ...
               <fo:block-container width="5cm" top="23.8cm" left="12.5cm" position="absolute">
                <fo:block>
                  <fo:external-graphic content-width="scale-to-fit" width="35%" height="35%" src="Rhone-Alpes.jpg"/>
                </fo:block>
               </fo:block-container>
               <fo:block-container width="5cm" top="23.5cm" left="15cm" position="absolute">
                <fo:block>
                  <fo:external-graphic content-width="scale-to-fit" width="35%" height="35%" src="Europe.png"/>
                </fo:block>
               </fo:block-container>
